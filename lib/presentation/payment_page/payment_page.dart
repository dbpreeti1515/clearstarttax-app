...
class PaymentPage extends GetView<PaymentController> {
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                  ...
                                                  child: Obx(() => Form(
                                                        ...
                                                        child:
                                                            CustomTextFormField(
                                                                //  autofocus: controller.autoValidate.value,
                                                                onChange: (value) {
                                                                  if (controller
                                                                      .paymentFormKey
                                                                      .currentState!
                                                                ...
                                                                focusNode: controller.paymentFocus,
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      CustomTextFormField(
          onChange: (value) {
            ...
            if (bankTransfer == 1){
              if (controller.transerFormKey.currentState!
                  .validate()) {}
            }else{
              if (controller.formKey.currentState!.validate()) {}
            }
  ...
  Widget zipDetails(
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      CustomTextFormField(
          onChange: (value) {
            if(InputController==controller.zipController){


            if (controller.formKey.currentState!.validate()) {}}
            else{
              if(controller.transerFormKey.currentState!.validate()){
              ...
              validator: (value) {
                if (controller.isMonthField.value == true) {
                  if (value == null || value.trim().isEmpty) {
                    ...
                    controller.expirydateValidation.value = "msg_enter_year".tr;
                  } else {
                    controller.expirydateValidation.value = '';
                  }
                }
  ...
  Widget _buildScrollViewSection(BuildContext context) {
    return Column(children: [
      ...
      CW.statusCard(text: "msg_payment_schedule".tr, height: 57.v),
      Padding(
                      ...
                      Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20.v),
                            _buildInputFeild(
                              'msg_street_address1'.tr,
                              'msg_enter_address1'.tr,
                              (value) {
                                if (value == null || value.trim().isEmpty) {
                                  return "msg_enter_this_field".tr;
                                }
                                ...
                                //     .hasMatch(value)) {
                                //   return 'msg_valid_address'.tr;
                                // }
                                return null;
                              },
                              controller.add1Controller,
                              [],
                              controller.focusNodes[6],
                            ),
                            SizedBox(height: 14.v),
                            _buildInputFeild(
                              'msg_street_address2'.tr,
                              'msg_enter_address2'.tr,
                              (value) {
                                return null;
                              },
                              controller.add2Controller,
                              [],
                              controller.focusNodes[7],
                            ),
                            SizedBox(height: 14.v),
                            _buildInputFeild(
                              'msg_city'.tr,
                          ...
                          children: [
                            _buildInputFeild(
                              ...
                              return null;
                                ...
                                textInputType: TextInputType.name,bankTransfer: 1),
                            SizedBox(height: 14.v),
                            _buildInputFeild('msg_account_name'.tr,
                                'msg_enter_account_name'.tr, (value) {
                              if (value == null ||
                                  value == null ||
                                  value.trim().isEmpty) {
                                return "msg_enter_this_field".tr;
                            ...
                            SizedBox(height: 14.v),
                            _buildInputFeild(
                                'msg_routing'.tr, 'Enter routing'.tr, (value) {
                              if (value == null ||
                                  value == null ||
                                  value.trim().isEmpty) {
                                return "msg_enter_this_field".tr;
                              ...
                              return null;
                                ...
                                controller.focusNodes[11],
                                textInputType: TextInputType.number,bankTransfer: 1),
                            SizedBox(height: 14.v),
                            _buildInputFeild(
                                'msg_account'.tr, 'Enter account number'.tr,
                                (value) {
                              if (value == null ||
                                  value == null ||
                                  value.trim().isEmpty) {
                            ...
                            _buildInputFeild(
                              ...
                              controller.transferAdd1Controller,
                              [],
                              controller.focusNodes[13],
                                bankTransfer: 1
                            ),
                            SizedBox(height: 14.v),
                            _buildInputFeild(
                              ...
                              controller.transferAdd2Controller,
                              [],
                              controller.focusNodes[14]
                                ,bankTransfer: 1
                            ),
                            SizedBox(height: 14.v),
                            _buildInputFeild(
                            ...
                            _stateDropdown(context,
                                controller.transferSelectValue.value, 2),
                            SizedBox(height: 14.v),
                            zipDetails(
                              controller.transferZipController,
                              controller.focusNodes[17],
                            ),
                            SizedBox(height: 14.v),
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              contentPadding:
                  EdgeInsets.only(bottom: mediaQueryData.size.height * 0.015),
            ),
